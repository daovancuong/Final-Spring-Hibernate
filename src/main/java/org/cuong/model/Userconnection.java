 ...
 */
@Entity
@Table(name = "userconnection", catalog = "mkyong", uniqueConstraints = @UniqueConstraint(columnNames = { "USERID",
		"PROVIDERID", "RANK" }))
public class Userconnection implements java.io.Serializable {
	...
	public Userconnection(UserconnectionId id, int rank, String displayname, String profileurl, String imageurl,
